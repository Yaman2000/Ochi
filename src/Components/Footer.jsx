...
function Footer() {
  return (
    <>
    <div className='w-full h-screen bg-white p-20 flex colunmn  gap-24'>
        <div className="w-1/2 flex flex-col justify-between font-semibold">
           <div>
    ...
    <div className='w-1/2'>
    <h1 className='text-8xl uppercase mt-10 font-semibold'>PRESETATION</h1>
    <div className='dets mt-28 text-lg'>
        <a className="block text" href="#">Facebook</a>
        <a className="block text" href="#">Instagram</a>
        <a className="block text" href="#">Twitter</a>
        <a className="block text" href="#">Gmail</a>
    </div>


    <div className='dets mt-28 text-lg'>
        <a className="block text" href="#">Home</a>
        <a className="block text" href="#">Service</a>
        <a className="block text" href="#">About Us</a>
        <a className="block text" href="#">Contact Us</a>
    </div>
    </div>
    </div>
